...
namespace HMS_HospitalManagementSystem_.AdminPanel
{
    public partial class ipregister : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int pid = 0;
            int b = 0;
            pid = Convert.ToInt32(new SqlCommand("select patientid from hospital_inpatient order by 1 desc", con).ExecuteScalar().ToString()) + 1;
            b = Convert.ToInt32(new SqlCommand("select admid from hospital_inpatient order by 1 desc", con).ExecuteScalar().ToString()) + 1;
